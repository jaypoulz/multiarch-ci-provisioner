#!/bin/bash
#
# Adds a function to install the dependecies to install OpenShift and the provisioner.
...
function setup_dependencies() {
    ...
    # TODO Allow a flag to be passed to override the OpenShift version
    ...
    #fi
    echo "Installing OpenShift $default_openshift_version"
    openshift_version=$default_openshift_version
